...
$(document).ready((function(){$(".header__burger").click((function(e){$(".header__float, .header__burger").toggleClass("active"),$("body").toggleClass("overflow-hidden")}))})),$(".autor__row").slick({dots:!0,infinite:!0,speed:500,fade:!0,cssEase:"linear",arrows:!1}),$(document).ready((function(){$(window).scroll((function(){this.scrollY>300?$(".scroll__up-btn").addClass("show"):$(".scroll__up-btn").removeClass("show")}))})),$(".scroll__up-btn").click((function(){$("html").animate({scrollTop:0})}));var typed=new Typed(".typing",{strings:["Хотите продающий сайт?","Создаем сайты с нуля!","Любой сложности!"],typeSpeed:100,backSpeed:60,loop:!0});